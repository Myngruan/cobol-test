...
public class Multip {
    ...
    public void calc1() {
        System.out.println("Enter the first number: ");
                ...
                // Original: ACCEPT Number1
                // Tipo: accept
                throw new UnsupportedOperationException("Conversão manual necessária: accept");
                System.out.println("Enter the second number: ");
                // TODO: [CONVERSÃO MANUAL NECESSÁRIA] Comando COBOL não suportado
                // Original: ACCEPT Number2
                // Tipo: accept
                throw new UnsupportedOperationException("Conversão manual necessária: accept");
                result1 = number1 * number2; // ou number1.multiply(number2) para BigDecimal
                System.out.println("Displaying first result!");
                result1f = String.valueOf(result1);
    ...
    public void calc2() {
        System.out.println("Enter the third number: ");
                // TODO: [CONVERSÃO MANUAL NECESSÁRIA] Comando COBOL não suportado
                // Original: ACCEPT Number3
                // Tipo: accept
                throw new UnsupportedOperationException("Conversão manual necessária: accept");
                System.out.println("Enter the fourth number: ");
                // TODO: [CONVERSÃO MANUAL NECESSÁRIA] Comando COBOL não suportado
                // Original: ACCEPT Number4
                // Tipo: accept
                throw new UnsupportedOperationException("Conversão manual necessária: accept");
                result2 = number3 * number4; // ou number3.multiply(number4) para BigDecimal
                System.out.println("Displaying second result!");
                result2f = String.valueOf(result2);
                System.out.println(result2f);
                total = total + result1 + result2; // ou total.add(result1,result2) para BigDecimal
                formatted = String.valueOf(total);

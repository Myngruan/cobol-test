...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | PerformTimes.cbl, HelloWorld.cbl, Message.cbl, IF-Example.cbl, NestedIFExample.cbl, IncrementExample.cbl, UserInput.cbl, Multiply.cbl, SeqFileExample.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-03-11 11:23:38 |

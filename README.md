...
- Geração de relatório/arquivo de saída
- Cálculos com precisão decimal (monetários)
...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | Message.cbl, HelloWorld.cbl, PerformTimes.cbl, NestedIFExample.cbl, IncrementExample.cbl, IF-Example.cbl, UserInput.cbl, Multiply.cbl, PerformExample.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-16 09:18:56 |

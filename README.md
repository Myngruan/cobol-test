...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | HelloWorld.cbl, Message.cbl, PerformTimes.cbl, UserInput.cbl, IncrementExample.cbl, NestedIFExample.cbl, IF-Example.cbl, PerformExample.cbl, Multiply.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-05 12:42:09 |

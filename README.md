...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | Message.cbl, HelloWorld.cbl, PerformTimes.cbl, Multiply.cbl, NestedIFExample.cbl, IF-Example.cbl, IncrementExample.cbl, UserInput.cbl, SeqFileExample.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-03-13 13:50:47 |

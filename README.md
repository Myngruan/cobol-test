...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | PerformTimes.cbl, Multiply.cbl, SeqFileExample.cbl, Message.cbl, IncrementExample.cbl, HelloWorld.cbl, NestedIFExample.cbl, IF-Example.cbl, UserInput.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-02-27 16:00:42 |

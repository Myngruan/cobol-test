...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | PerformTimes.cbl, Message.cbl, HelloWorld.cbl, UserInput.cbl, IF-Example.cbl, NestedIFExample.cbl, SeqFileExample.cbl, IncrementExample.cbl, Multiply.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-02-27 14:18:22 |

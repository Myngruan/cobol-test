...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | Message.cbl, HelloWorld.cbl, PerformTimes.cbl, UserInput.cbl, IF-Example.cbl, NestedIFExample.cbl, IncrementExample.cbl, Multiply.cbl, SeqFileExample.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-03-05 12:53:51 |

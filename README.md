...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | NestedIFExample.cbl, IF-Example.cbl, Multiply.cbl, Message.cbl, HelloWorld.cbl, PerformTimes.cbl, UserInput.cbl, IncrementExample.cbl, PerformExample.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-03 13:33:04 |

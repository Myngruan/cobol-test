...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | UserInput.cbl, IncrementExample.cbl, HelloWorld.cbl, Message.cbl, PerformTimes.cbl, SeqFileExample.cbl, PerformExample.cbl, IF-Example.cbl, NestedIFExample.cbl, Multiply.cbl |
| **Data da conversão** | 2026-03-16 08:50:03 |

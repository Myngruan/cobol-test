...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | UserInput.cbl, Message.cbl, HelloWorld.cbl, NestedIFExample.cbl, IF-Example.cbl, PerformTimes.cbl, IncrementExample.cbl, PerformExample.cbl, Multiply.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-11 12:52:49 |

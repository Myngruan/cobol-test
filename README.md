...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | IF-Example.cbl, IncrementExample.cbl, Multiply.cbl, Message.cbl, SeqFileExample.cbl, PerformExample.cbl, UserInput.cbl, NestedIFExample.cbl, PerformTimes.cbl, HelloWorld.cbl |
| **Data da conversão** | 2026-03-11 10:53:00 |

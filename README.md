...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | UserInput.cbl, HelloWorld.cbl, IncrementExample.cbl, Message.cbl, IF-Example.cbl, SeqFileExample.cbl, Multiply.cbl, NestedIFExample.cbl, PerformExample.cbl, PerformTimes.cbl |
| **Data da conversão** | 2026-03-11 10:36:05 |
...
```bash
# Via Maven
mvn exec:java -Dexec.mainClass="com.converted.cobol.Userinput"

# Ou via Java diretamente
java -cp target/classes com.converted.cobol.Userinput
```

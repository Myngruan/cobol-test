...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | Message.cbl, HelloWorld.cbl, PerformExample.cbl, PerformTimes.cbl, UserInput.cbl, NestedIFExample.cbl, IF-Example.cbl, Multiply.cbl, SeqFileExample.cbl, IncrementExample.cbl |
| **Data da conversão** | 2026-03-04 12:36:16 |

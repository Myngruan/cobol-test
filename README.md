...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | UserInput.cbl, NestedIFExample.cbl, IncrementExample.cbl, PerformExample.cbl, Multiply.cbl, SeqFileExample.cbl, Message.cbl, IF-Example.cbl, PerformTimes.cbl, HelloWorld.cbl |
| **Data da conversão** | 2026-03-11 11:00:28 |

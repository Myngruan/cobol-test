...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | HelloWorld.cbl, Message.cbl, PerformTimes.cbl, NestedIFExample.cbl, UserInput.cbl, IF-Example.cbl, IncrementExample.cbl, PerformExample.cbl, Multiply.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-09 16:21:42 |

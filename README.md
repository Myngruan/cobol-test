...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | Message.cbl, SeqFileExample.cbl, HelloWorld.cbl, Multiply.cbl, PerformTimes.cbl, IF-Example.cbl, UserInput.cbl, IncrementExample.cbl, NestedIFExample.cbl, PerformExample.cbl |
| **Data da conversão** | 2026-03-16 08:31:06 |

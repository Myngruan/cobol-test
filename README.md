...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | HelloWorld.cbl, SeqFileExample.cbl, IncrementExample.cbl, Message.cbl, PerformExample.cbl, NestedIFExample.cbl, IF-Example.cbl, UserInput.cbl, Multiply.cbl, PerformTimes.cbl |
| **Data da conversão** | 2026-03-11 09:18:15 |

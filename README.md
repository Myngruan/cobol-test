...
| Item | Valor |
|------|-------|
| **Arquivos COBOL convertidos** | HelloWorld.cbl, PerformTimes.cbl, Message.cbl, UserInput.cbl, Multiply.cbl, IncrementExample.cbl, IF-Example.cbl, NestedIFExample.cbl, PerformExample.cbl, SeqFileExample.cbl |
| **Data da conversão** | 2026-03-04 12:29:39 |
